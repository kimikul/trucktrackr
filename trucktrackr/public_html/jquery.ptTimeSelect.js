		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
					...
					+	'						class="ui-corner-all ui-state-default" style="text-decoration: none;">'
					+	'					<span class="ui-icon ui-icon-circle-close"><strong>x</strong></span>'
					+	'				</a>'
					+	'			</div>'
					+	'			<div id="ptTimeSelectUserTime" style="float: left;">'
					+	'				<span id="ptTimeSelectUserSelHr">7</span>:<span id="ptTimeSelectUserSelMin">00</span> '
					...
					+	'					<div class="ptTimeSelectLeftPane" style="width: 50%; text-align: left; float: left;" class="">Hour</div>'
					+	'					<div class="ptTimeSelectRightPane" style="width: 50%; text-align: left; float: left;">Minutes</div>'
					+	'				</div>'
					+	'				<div>'
					...
					+	'							</div>'
					+	'							<div class="ptTimeSelectHrAmPmCntr" style="margin-top: 10px;">'
					+	'								<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" '
					+	'										style="display: block; width: 45%; float: left; text-decoration: none;">AM</a>'
					+	'								<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" '
					+	'										style="display: block; width: 45%; float: left; text-decoration: none;">PM</a>'
					+	'								<br style="clear: left;" /><div></div>'
					+	'							</div>'
					+	'						</div>'
					+	'					</div>'
